...
BEGIN
    CREATE TABLE dbo.UserSettings (
        ...
        -- Adaptive engine
        adaptive_enabled     BIT          NOT NULL CONSTRAINT DF_UserSettings_adaptive_enabled DEFAULT 0,
        adaptive_params      NVARCHAR(MAX)    NULL,
...
BEGIN
    CREATE TABLE dbo.DoseCalculations (
        ...
        -- Outcome tracking
        confirmed_administered BIT         NOT NULL CONSTRAINT DF_DoseCalculations_confirmed_administered DEFAULT 0,
